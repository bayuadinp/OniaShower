...
namespace Rivet {
  ...
  class CMS_2022_I1870319_FineBin_R4 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(CMS_2022_I1870319_FineBin_R4);
  ...
  RIVET_DECLARE_PLUGIN(CMS_2022_I1870319_FineBin_R4);
