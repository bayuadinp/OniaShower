...
namespace Rivet {
  ...
  class CMS_2022_I1870319_50Bin_R3 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(CMS_2022_I1870319_50Bin_R3);
    ...
    void init() {
      ...
      const int NUM_BINS = 50; // For a bin width of (1.0 - 0.0) / 100 = 0.01
  ...
  RIVET_DECLARE_PLUGIN(CMS_2022_I1870319_50Bin_R3);
