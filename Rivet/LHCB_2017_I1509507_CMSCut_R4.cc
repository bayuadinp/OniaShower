...
namespace Rivet {
  ...
  class LHCB_2017_I1509507_CMSCut_R4 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(LHCB_2017_I1509507_CMSCut_R4);
  ...
  RIVET_DECLARE_PLUGIN(LHCB_2017_I1509507_CMSCut_R4);
