...
namespace Rivet {
  ...
  class CMS_2022_I1870319_100Bin_R3 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(CMS_2022_I1870319_100Bin_R3);
  ...
  RIVET_DECLARE_PLUGIN(CMS_2022_I1870319_100Bin_R3);
